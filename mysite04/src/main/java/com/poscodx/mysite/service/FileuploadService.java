...
public class FileuploadService {
	...
	public String restore(MultipartFile file) {
		...
		String url = null;
		try {
			File uploadDirectory = new File(env.getProperty("fileupload.uploadResource"));
			if(!uploadDirectory.exists()) {
				uploadDirectory.mkdir();
			}
	
			if(file.isEmpty()) {
				return "/assets/images/loopy.jpg";
			}
			...
			OutputStream os = new FileOutputStream(env.getProperty("fileupload.uploadResource") + "/" + saveFilename);
			os.write(data);
			os.close();
